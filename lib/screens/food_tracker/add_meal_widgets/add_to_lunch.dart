...
class AddToLunch extends StatefulWidget {
  ...
  @override
  _AddToLunchState createState() => _AddToLunchState();
}

class _AddToLunchState extends State<AddToLunch> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: primaryBackgroundColor,
        title: Text('Log Your Lunch',
        style: titleTextStyle,),
        centerTitle: true,
      ),
      body: _addToLunchBody(),
    );
  }

  Widget _addToLunchBody(){
    return Column(
      children: <Widget>[
        lunchHeader(),
        addFoodButton(),
            ...
            title: Column(
              children: <Widget>[
                Padding(
                  ...
                  child: Text('Removing from your lunch:',
