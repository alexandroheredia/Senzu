...
class FoodDetailsForMeals extends StatefulWidget {
  ...
  @override
  _FoodDetailsForMealsState createState() => _FoodDetailsForMealsState();
}

class _FoodDetailsForMealsState extends State<FoodDetailsForMeals> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _foodDetailsForMealsBody(),
    );
  }

  _foodDetailsForMealsBody(){
    return Column(
      children: <Widget>[
        _foodDetailsBody(),
