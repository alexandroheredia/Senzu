...
const proteinData = NutrientPage(
  ...
  rows: [
    NutrientRow(
      rank: '🥇',
      foodName: 'Textured Soy',
      amount: '108 g',
      percent: '174.16%',
    ),
    NutrientRow(
      rank: '🥈',
      foodName: 'Grated Parmesan',
      amount: '36 g',
      percent: '57.74%',
    ),
    NutrientRow(
